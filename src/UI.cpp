...
void DrawPie(SDL_Renderer* renderer){
    ...
    const std::vector<float> values = {30.0f,25.0f,15.0f,10.0f,20.0f };
    const std::vector<const char*> labels = {"maths","GAP","anglais","AIA","sport" };
    //const std::vector<ImU32> colors = {IM_COL32(255,0,0,255),IM_COL32(255,255,0,255),IM_COL32(128,0,128,255),IM_COL32(0,0,255,255)};
